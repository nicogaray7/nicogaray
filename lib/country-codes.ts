// ISO 3166-1 numeric → alpha-2 lookup used to bridge world-atlas IDs (numeric)
// with our DB countryCode (alpha-2).
// Trimmed to commonly visited countries; unknown numeric ids return null.
...
export const numericToAlpha2: Record<string, string> = {
  ...
  '480': 'MU', '484': 'MX', '496': 'MN', '498': 'MD', '499': 'ME', '504': 'MA',
