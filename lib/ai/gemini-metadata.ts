...
export async function generatePhotoMetadata(
  ...
  const prompt = [
    "Tu rédiges les légendes photo d'une galerie, dans le style éditorial de National Geographic :",
    'évocateur, vivant, ancré dans le réel, jamais un inventaire technique ni de la publicité.',
    'Écris en français soigné (accents corrects obligatoires).',
    '',
    "TITRE : court et évocateur (3 à 7 mots), qui suggère l'atmosphère, l'histoire ou l'échelle du lieu.",
    'Sans guillemets, sans point final. Ancre-le sur le lieu réel quand il apporte quelque chose.',
    "Ni description exhaustive, ni cliché (évite verdoyant, spectaculaire, apaisant, majestueux, baigné de soleil).",
    '',
    'DESCRIPTION : une à deux phrases façon légende National Geographic. Plante le décor,',
    'situe le lieu, glisse une touche d\'ambiance ou un détail marquant. Ton éditorial et concret,',
    'pas une énumération premier plan / arrière-plan, pas de lyrisme creux.',
    '',
    "N'invente aucun lieu absent des métadonnées. Varie le vocabulaire d'une photo à l'autre.",
